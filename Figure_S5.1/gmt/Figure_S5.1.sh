...
average_files=(
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc2km_yinc2km_weighting_equal/ACl_FILTERED_DATA_04_xinc2km_yinc2km_weighting_equal_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc2km_yinc2km_weighting_inv_dist/ACl_FILTERED_DATA_04_xinc2km_yinc2km_weighting_inv_dist_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc2km_yinc2km_weighting_inv_dist2/ACl_FILTERED_DATA_04_xinc2km_yinc2km_weighting_inv_dist2_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc3km_yinc3km_weighting_equal/ACl_FILTERED_DATA_04_xinc3km_yinc3km_weighting_equal_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc3km_yinc3km_weighting_inv_dist/ACl_FILTERED_DATA_04_xinc3km_yinc3km_weighting_inv_dist_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc3km_yinc3km_weighting_inv_dist2/ACl_FILTERED_DATA_04_xinc3km_yinc3km_weighting_inv_dist2_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc5km_yinc5km_weighting_equal/ACl_FILTERED_DATA_04_xinc5km_yinc5km_weighting_equal_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc5km_yinc5km_weighting_inv_dist/ACl_FILTERED_DATA_04_xinc5km_yinc5km_weighting_inv_dist_grid_cells_SWA_source_to_station_averages.txt"
    "$GRID_DATA_DIR/ACl_FILTERED_DATA_04_xinc5km_yinc5km_weighting_inv_dist2/ACl_FILTERED_DATA_04_xinc5km_yinc5km_weighting_inv_dist2_grid_cells_SWA_source_to_station_averages.txt"
)
...
panel_titles=(
    ...
    "3km Grid Spacing, 1/d^2 Weighting"
...
gmt colorbar -Cswa.cpt -Dx9c/-1.3c+w20c/0.5c+h -Bpa2f1+l"SWA" -By -G0/6
