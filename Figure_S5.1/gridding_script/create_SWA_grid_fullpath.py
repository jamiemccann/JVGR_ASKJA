...
# Same batch grid as Figure_S4.1/gridding_script/create_fast_polarisation_grid.py
...
def run_gridding_for_config(input_file, x_inc, y_inc, weighting_mode):
    ...
    # Only export lon, lat, geometric mean of SWA_source_to_station, and node count
